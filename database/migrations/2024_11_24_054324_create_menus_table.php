    ...
    protected function insertMenuData()
    {
        ...
        DB::table('menus')->insert([
            ...
            [
                ...
                'active_routes' => json_encode(['parent/dashboard']),
                'pattern'   => null,
                'parent_id' => $dashboardMenuId,
                'order'     => 2,
                'is_active' => true,
        ...
        $parentMenuId = DB::table('menus')->insertGetId([
            ...
            'icon'  => 'fas fa-users',
            'route' => null,
            'active_routes' => json_encode(['parent/list', 'parent/add/page']),
            'pattern'   => 'parent/edit/*',
            'parent_id' => null,
            'order'     => 4,
            'is_active' => true,
        ...
        DB::table('menus')->insert([
            [
                ...
                'icon'  => null,
                'route' => 'parent/list',
                'active_routes' => json_encode(['parent/list']),
                'pattern'   => null,
            ...
            [
                'title' => 'Add Parent',
                'icon'  => null,
                'route' => 'parent/add/page',
                'active_routes' => json_encode(['parent/add/page']),
                'pattern'   => null,
                'parent_id' => $parentMenuId,
                'order'     => 2,
                'is_active' => true,
