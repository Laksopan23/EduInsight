                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="DataList" class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <tbody>
                                    @foreach ($teacherList as $list) <!-- Fixed to teacherList -->
                                    <tr>
                                        <td>
                                            <div class="form-check check-tables">
                                                <input class="form-check-input" type="checkbox" value="something">
                                        ...
                                        <td hidden class="teacher_id">{{ $list->id }}</td> <!-- Store Teacher ID -->
                                        <td>{{ $list->id }}</td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <!-- Removed avatar since Teacher doesn't have it -->
                                        ...
                                        <td class="text-end">
                                            <div class="actions">
                                                <a href="{{ url('teacher/edit/'.$list->id) }}" class="btn btn-sm bg-danger-light"> <!-- Use id -->
